...
public class Solution1603 {
    private Stack bigStack;
    private Stack mediumStack;
    private Stack smallStack;

    public Solution1603(int big, int medium, int small) {
        this.bigStack = new Stack();
        this.mediumStack = new Stack();
        this.smallStack = new Stack();
        for (int i = 0; i < big; i++) {
            bigStack.push(i);
        }
...
class Solution1603_1{
    private int big;
    private int medium;
    private int small;
    public Solution1603_1(int big, int medium, int small){
        this.big = big;
        this.medium = medium;
        this.small = small;
    }
